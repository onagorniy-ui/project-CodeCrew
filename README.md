...
Фінальне тестування застосунку проведено 27.08.2026.

Під час тестування:

- створено 10 тестових контактів із телефонами, email, адресами та днями народження;
- створено 5 нотаток із текстом і тегами;
- перевірено додавання, зміну, пошук і видалення контактів;
- перевірено додавання, редагування, пошук, сортування та видалення нотаток;
- перевірено пошук нотаток за текстом і тегами;
- перевірено пошук контактів за ім’ям, телефоном, email та адресою;
- перевірено відображення найближчих днів народження;
- перевірено обробку неправильного номера телефону, email, дати народження, відсутніх аргументів і невідомої команди;
- перевірено завершення роботи командами `exit` та збереження даних;
- після перезапуску застосунку всі 10 контактів і 5 нотаток були успішно завантажені.

Аварійних завершень програми під час тестування не виявлено.